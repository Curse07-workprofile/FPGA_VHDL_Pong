...
This project utilizes a from scratch **UART** implementation in VHDL to serially communicate with a terminal on PC. 
This projects the output and takes the key inputs from the PC to play the classic Pong Game again in VHDL.
