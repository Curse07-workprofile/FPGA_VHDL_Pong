...
set_false_path -from [get_ports {BTN[4]}]
set_false_path -from [get_ports CPU_RESETN]
set_false_path -from [get_ports UART_TXD_IN]

set_false_path -to [get_ports -filter { NAME =~ "AN*"   && DIRECTION == "OUT" }]
set_false_path -to [get_ports -filter { NAME =~ "C*"    && DIRECTION == "OUT" }]
set_false_path -to [get_ports -filter { NAME =~ "LED*"  && DIRECTION == "OUT" }]
set_false_path -to [get_ports -filter { NAME =~ "*UART*" && DIRECTION == "OUT" }]
